...
clear
rm -f /usr/bin/user
username=$(curl https://raw.githubusercontent.com/Tikusmerdeka/Backenv4/main/ip | grep $MYIP | awk '{print $2}')
echo "$username" >/usr/bin/user
expx=$(curl https://raw.githubusercontent.com/Tikusmerdeka/Backenv4/main/ip | grep $MYIP | awk '{print $3}')
echo "$expx" >/usr/bin/e
...
Exp1=$(curl https://raw.githubusercontent.com/Tikusmerdeka/Backenv4/main/ip | grep $MYIP | awk '{print $4}')
if [[ $today < $Exp1 ]]; then
sts="${Info}"
else
sts="${Error}"
...
clear
restart_system() {
USRSC=$(wget -qO- https://raw.githubusercontent.com/Tikusmerdeka/Backenv4/main/ip | grep $ipsaya | awk '{print $2}')
EXPSC=$(wget -qO- https://raw.githubusercontent.com/Tikusmerdeka/Backenv4/main/ip | grep $ipsaya | awk '{print $3}')
...
wget raw.githubusercontent.com/Tikusmerdeka/Backenv4/main/files/limit.sh && chmod +x limit.sh && ./limit.sh
cd
...
cd /bin
git clone  https://github.com/gendonpem/wondershaper.git
cd wondershaper
sudo make install
cd
rm -rf wondershaper
